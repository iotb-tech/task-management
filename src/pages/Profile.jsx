   ...
   const [showProfile, setEditProfile] = useState(false)
    ...
    return (
        ...
        <div className="bg-gray-50 mx-auto lg:w-1/3  md:w-1/2 justify-items-center  rounded-xl  pb-20">
         ...
         <button onClick={ () => setEditProfile(true)} className="bg-cyan-950 text-white pl-6 pr-6 rounded-2xl pt-1 pb-1 mt-3">Edit profile</button>
         ...
         <div  className="mt-10 secondary-font">
            ...
            <div className="mb-6 xl:-ml-1">
                 <button onClick={toggleMenu} className="mt-3  pl-3 xl:pr-48 md:pr-32 max-sm:pr-32 pt-1 pb-1 rounded-md border-1 border-cyan-700 ">  List of completed task</button>
                 <div className={`shadow-2xl rounded-xl mt-4 pl-4  pt-2 pb-2 card  max-sm
                  ${isOpen ? "block" : "hidden"} `} >
             ...
             <div className="mt-3   ">
               <button onClick={toggleMenus} className="pl-5 xl:pr-48 md:pr-32 max-sm:pr-32 pt-1 pb-1 rounded-md border-cyan-700 border-1" >List of pending tasks</button>  
             <div
