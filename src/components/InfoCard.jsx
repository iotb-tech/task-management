...
const InfoCard = ({ number, info, icon }) => {
  return (
    <div className="w-full max-w-sm md:max-w-md lg:max-w-xs h-auto p-6 card flex flex-col justify-center items-center gap-2 grow text-center rounded-4xl mb-[4%]">
