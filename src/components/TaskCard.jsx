...
const TaskCard = ({ task, handleDelete }) => {
    ...
    return (
        <div className={`${isLightMode ? "primary-color" : "secondary-color"} relative w-full sm:w-[300px] primary-font p-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 border border-gray-200`}>
            <button
